...
namespace exercicio2_Luiz_Felipe
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            totalS = calc.soma(item1, item2,  item3,  item4);
            Multi5 = calc.multi5(totalS);
            Multi20 = calc.multi20(totalS);

            float totalmult20 = Multi20;
            Divi = calc.divi20(totalmult20);
            float totaldisc20 = totalS - Divi;

            float totalmult5 = Multi5;
            Divi = calc.divi5(totalmult5);
            float totaldisc5 = totalS - Divi;

             P2 = calc.parcela2(totalS);
            P3 = calc.parcela3(totalS);
